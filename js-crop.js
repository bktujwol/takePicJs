...
class jsCrop {
    ...
    */
    ...
    createOverlay(img,param2,param3) {
        ...
        overlayDivEl.style = `z-index:100500;top:0%;left:0%;right:0%;bottom:0%;height:${window.innerHeight}px;width:${window.innerWidth}px;background-color:${overlayBgColor};`;
